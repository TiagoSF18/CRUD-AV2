      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h6 class="m-0 text-dark">Lista de Clientes Cadastrados</h6>
    ...
    <section class="content">
            ...
            if (isset($_SESSION['msg_del'])){
              ...
              <script>
                window.onload = function(){
                  toastr.info('Cliente Excluido com Sucesso!')
                } 
              </script>";
            }
      ...
      <div class="card">
              <div class="card-header">
                ...
                <small class="float-right"><a href="add_dist.php"> <button type="button" class="btn btn-block btn-primary">Add Cliente</button></a>    </small>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
  ...
  <div class="modal-dialog">
    <div class="modal-content bg-danger">
      ...
      <div class="modal-body">
        <p>Tem certeza que deseja excluir permanentemente os dados deste cliente?</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-light" data-dismiss="modal">Cancelar</button>
        <a class="btn btn-outline-light btn-ok">Sim! Confirmar.</a>
